...
function RewardTokenListForPoolDetail({
  ...
  return (
    <div className="flex flex-col py-2 px-4 bg-[#141D2D]/70 rounded-[20px] text-lg gap-2 2xl:text-xl">
      <div className="flex flex-row gap-2 lg:gap-2 md:gap-10">
        <div className="flex flex-col">
          <Image
            ...
            alt="bread"
          />
          <p className="">{isERC1155 ? 'ERC1155' : 'ERC20'}</p>
        </div>
        <div className="flex flex-row justify-between items-center w-full gap-1">
          ...
          <div className="flex flex-col gap-1 2xl:flex lg:hidden">
            <p className="truncate tracking-[-1px]">Token Address</p>
            <p className="text-sm w-48 break-all">{tokenAddress || ''}</p>
          </div>
          {isERC1155 && (
            <div className="flex flex-col gap-2 2xl:flex lg:hidden">
      ...
      <div className="hidden flex-row justify-between w-full 2xl:hidden lg:flex">
        <div
          className={`flex ${
